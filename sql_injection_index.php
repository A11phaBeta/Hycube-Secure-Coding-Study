...
if(isset($_POST['id']) && isset($_POST['pw'])){
    ...
    $idVal = str_replace("'", "", $_POST['id']);
    $sql = "select count(*), user_id from user_information where user_web_id = '".$idVal."' and user_web_password = '".$_POST['pw']."'";
    $result = ysqli_query($conn, $sql);
...
<!-- Secure Code (2) prepare statement -->
